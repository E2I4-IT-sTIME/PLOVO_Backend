...
select * from plovo;
insert into plovo(current_weight, date, img, weight, mountain_id) values('0', '', 'img1', '0', 1);
insert into plovo(current_weight, date, img, weight, mountain_id) values('0', '', 'img1', '0', 2);
insert into plovo(current_weight, date, img, weight, mountain_id) values('0', '', 'img1', '0', 3);
insert into plovo(current_weight, date, img, weight, mountain_id) values('0', '', 'img1', '0', 4);
insert into plovo(current_weight, date, img, weight, mountain_id) values('0', '', 'img1', '0', 5);